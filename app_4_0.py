...
INGREDIENTS = [['1', 'masalliq 1', 'ingredient 1'], ['2', 'masalliq 2', 'ingredient 2'],
               ['3', 'masalliq 3', 'ingredient 3'], ['4', 'masalliq 4', 'ingredient 4'],
               ['5', 'masalliq 5', 'ingredient 5'], ['6', 'masalliq 6', 'ingredient 6'],
               ['7', 'masalliq 7', 'ingredient 7'], ['8', 'masalliq 8', 'ingredient 8'],
               ['9', 'masalliq 9', 'ingredient 9'], ['10', 'masalliq 10', 'ingredient 10'],
               ['11', 'masalliq 11', 'ingredient 11'], ['12', 'masalliq 12', 'ingredient 12'],
               ['13', 'masalliq 13', 'ingredient 13'], ['14', 'masalliq 14', 'ingredient 14'],
               ['15', 'masalliq 15', 'ingredient 15'], ['16', 'masalliq 16', 'ingredient 16'],
               ['17', 'masalliq 17', 'ingredient 17'], ['18', 'masalliq 18', 'ingredient 18'],
               ['19', 'masalliq 19', 'ingredient 19'], ['20', 'masalliq 20', 'ingredient 20'],
               ['21', 'masalliq 21', 'ingredient 21'], ['22', 'masalliq 22', 'ingredient 22'],
               ['23', 'masalliq 23', 'ingredient 23'], ['24', 'masalliq 24', 'ingredient 24'],
...
MEALS = [['1', "Osh Palov (Plov)", "English version", 234], ['2', "nobody knows", "random", 432]]
RECIPE = [
    {
        "id": 1,
        "name": "Osh Palov (Plov)",
    ...
    if 'message' in update:
        if 'text' in update['message']:
            ...
            if message == '/start':
                ...
                keyboard = {'keyboard': options_split, 'one_time_keyboard': False, 'resize_keyboard': True}
                ...
                for meal in RECIPE:
                    ...
                    if all_present:  # here you should add addtitional condition if the meal matches with the condition user put using the variables is_healthy, is_diabetic and is_extra_weight
                        reply_markup['inline_keyboard'].append(
                            [{'text': f"{meal['name']}", 'callback_data': f"M{meal['id']}"}])
            else:
